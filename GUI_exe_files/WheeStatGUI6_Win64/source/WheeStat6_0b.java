...
public class WheeStat6_0b extends PApplet {

/*  WheeStat6_0 Processing sketch
 *    6/10/15
...
Textfield Starting_Voltage, End_Voltage, Scan_Rate, Delay_Time, Gain, offset, fileName;
...
public void hide(){
 ...
 for (int b = 0; b<10; b++){
   ...
   showChart[fileCount-b] = !showChart[fileCount-b];
...
public void legend(int k, int off){
  translate(legBoxX,legBoxY+off);
       ...
       strokeWeight(2); 
       line(5, 7,25,7);          
//       stroke(red[runCount-k],green[runCount-k],blue[runCount-k]); 
...
************************************/
  ...
  */ 
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "WheeStat6_0b" };
    if (passedArgs != null) {
